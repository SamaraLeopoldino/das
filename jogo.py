...
def batalha(vidaJogador, moedas, danoEspada, pocaoSono, protecaoEscudo):
    vidaInimigo = random.randint(100, 220) 
...
def loja(moedas):
    ...
    while True:
        ...
        if escolha == '1':
            if moedas >= 50:
                moedas -= 50
                danoEspada = random.choice([30, 40])  
...
def jogabilidade():
    ...
    vidaJogador = random.randint(200, 300)  
